    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_name', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='ut_login_name', to='home.customer')),
                ('untrusted_login_name', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='ut_untrusted_login_name', to='home.customer')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('login_name', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='t_login_name', to='home.customer')),
                ('trusted_login_name', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='t_trusted_login_name', to='home.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
            fields=[
                ...
                ('login_name', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='home.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Offense',
        ...
        migrations.AddConstraint(
            model_name='comment',
            constraint=models.UniqueConstraint(fields=('login_name', 'isbn'), name='unique comment'),
        ),
        migrations.AddConstraint(
            model_name='bookorder',
            constraint=models.UniqueConstraint(fields=('order_number', 'login_name', 'isbn'), name='unique item in order'),
        ),
        migrations.AddConstraint(
            model_name='author',
